...
export async function GET(req) {
    ...
    if (bearer_token === process.env.MASTER_BEARER_KEY) {
        ...
        const userQuizId = searchParams.get('user_quiz_id');


        if (!userQuizId || userQuizId.trim() === "") {
            ...
            try {
                ...
                if (Array.isArray(data) && data.length === 0) {
                    ...
                    return NextResponse.json({ message: "Results fetched successfully", data }, { status: 200 });
