                        ...
                        <div class="modal-body mb-3">
                            <div className="">
                                <div className="modal-header">
                                    <h1 class="modal-title fs-5" id="accountUpdateModal"><MdOutlinePayment size={20} /> Subscription</h1>
                                </div>

                                <div className="alert alert-danger">
                                    We're still in our Beta testing stage, so everything's free for now.
                                </div>
